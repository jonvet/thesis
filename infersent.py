...
if __name__ == '__main__':
    ...
    train, dev, test = data.get_nli(path)

    word_vec = data.build_vocab(train['s1'] + train['s2'] + dev['s1'] + dev['s2'] + test['s1'] + test['s2'], GLOVE_PATH)
    # word_vec = data.build_vocab(train['s1'] + train['s2'] + dev['s1'] + dev['s2'] + test['s1'] + test['s2'], SKIPTHOUGHT_PATH, skipthought=True)
